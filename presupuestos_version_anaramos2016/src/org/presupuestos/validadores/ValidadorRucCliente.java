...
public class ValidadorRucCliente implements IPropertyValidator, IWithMessage {
	...
	public void validate(Messages errors, Object value, String propertyName,
		...
		Query w = XPersistence.getManager().createQuery("select count(*) as q1 from Clientes k where upper(trim(k.ruc)) = :miruc");
